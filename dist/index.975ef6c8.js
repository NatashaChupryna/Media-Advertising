...
const imgAPI = new (0, _imgAPI.imagesAPI)();
const simpleligthbox = new (0, _simplelightboxDefault.default)(".gallery a");
...
function onFormSubmit(event) {
    ...
    imgAPI.resetPage();
    gallery.innerHTML = "";
    if (imgAPI.searchQuery === "") return (0, _notiflixDefault.default).Notify.failure('"Please, enter your query"');
    imgAPI.fetchImg().then((data)=>{
        ...
        if (data.data.hits.length) return (0, _notiflixDefault.default).Notify.success(`Hooray! We found ${data.data.totalHits} images.`);
    }).catch((error)=>{
...
function onLoadMoreBtn(event) {
    imgAPI.page += 1;
    imgAPI.fetchImg().then((data)=>{
        if (data.hits === data.data.totalHits) (0, _notiflixDefault.default).Notify.info(`We're sorry, but you've reached the end of search results.`);
...
},{"./css/styles.css":"1CY4s","notiflix":"5WWYd","./imgAPI":"aBEtN","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1CY4s":[function() {},{}],"5WWYd":[function(require,module,exports) {
var global = arguments[3];
...
},{}],"aBEtN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "imagesAPI", ()=>imagesAPI);
var _notiflix = require("notiflix");
var _notiflixDefault = parcelHelpers.interopDefault(_notiflix);
...
class imagesAPI {
    ...
    async fetchImg() {
        ...
        try {
            const response = await axios.get(`${BASE_URL}?key=${KEY}&q=${this.searchQuery}&image_type=photo&orientation=horizontal&safesearch=true&page=${this.page}&per_page=40`);
...
},{"notiflix":"5WWYd","axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
